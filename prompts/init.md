---
description: Create or update AGENTS.md for the repository with high-signal, agent-useful context
---
...
- content better stored in another referenced config file
